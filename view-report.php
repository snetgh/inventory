                    ...
                    <div class="page-content-wrapper">
                        <div class="container-fluid">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mb-4">Select Report</h4>
...
$id_array = [];  
$counter = 1;
$getReports = mysqli_query($connectionString,"SELECT * FROM reports ORDER BY id ASC")or die(mysqli_error($connectionString));
while($eachReports = mysqli_fetch_array($getReports)){  
    $id = $eachReports['secret_id'];
    $subject = $eachReports['report_subject'];
    $title = $eachReports['report_title'];
    $to = $eachReports['report_to'];
    $from = $eachReports['report_from'];
    $date = $eachReports['report_date'];
     ...
     <td><?php echo $title;  ?></td>
      <td><?php echo $to;  ?></td>
       <td><?php echo $from;  ?></td>
        <td><?php echo $date; ?></td>                                                                        
    <td>
        <a href="report.php?i=<?php echo $id; ?>" class="btn btn-outline-success btn-sm btn-edit">View Report</a>
    </td>
</tr>

 <?php  array_push($id_array, $id);$counter++;  }; ?>
